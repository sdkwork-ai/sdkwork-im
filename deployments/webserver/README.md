...
Module `sdkwork-im` · runtime code `im` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `im-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `im-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `im-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `im-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `im.sdkwork.com` | 443 ssl + 80 |
