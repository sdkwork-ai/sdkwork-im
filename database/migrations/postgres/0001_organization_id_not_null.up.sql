...
ALTER TABLE im_conversation_messages ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_conversation_seq_counters ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_message_media_refs ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_outbox_events ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_inbox_events ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_commit_journal ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_realtime_checkpoints ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_realtime_subscriptions ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_realtime_subscription_scopes ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_presence_states ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_route_bindings ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_realtime_disconnect_fences ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_rtc_sessions ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_notification_tasks ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_automation_executions ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_conversations ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_conversation_policies ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_conversation_business_bindings ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_conversation_handoffs ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_conversation_members ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_conversation_read_cursors ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_registered_client_routes ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_client_sync_events ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_client_sync_cursors ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_stream_sessions ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_stream_frames ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_friend_requests ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_friendships ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_user_blocks ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_direct_chats ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_external_connections ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_external_member_links ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_shared_channel_policies ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_spaces ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_contact_tags ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_contact_preferences ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_contact_recommendations ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_space_members ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_chat_groups ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_group_members ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_chat_channels ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_channel_access_rules ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_message_reactions ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_message_pins ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_user_settings ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_ban_records ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_group_knowledge_launch_tickets ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE im_conversation_agent_assignments ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE im_conversation_agent_binding ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE im_agent_dispatch ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
