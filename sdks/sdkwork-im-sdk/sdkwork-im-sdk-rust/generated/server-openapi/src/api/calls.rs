...
impl CallsApi {
    ...
    pub async fn sessions_credentials_refresh(&self, rtc_session_id: &str, body: &IssueRtcParticipantCredentialRequest) -> Result<RtcParticipantCredential, SdkworkError> {
