...
/// Generated client implementations.
pub mod group_knowledgebase_launch_ticket_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::http::Uri;
    #[derive(Debug, Clone)]
    pub struct GroupKnowledgebaseLaunchTicketServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl GroupKnowledgebaseLaunchTicketServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> GroupKnowledgebaseLaunchTicketServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> GroupKnowledgebaseLaunchTicketServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            GroupKnowledgebaseLaunchTicketServiceClient::new(
                InterceptedService::new(inner, interceptor),
            )
        }
        /// Compress requests with the given encoding.
        ...
        pub async fn consume_group_knowledgebase_launch_ticket(
            &mut self,
            request: impl tonic::IntoRequest<
                super::ConsumeGroupKnowledgebaseLaunchTicketRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::ConsumeGroupKnowledgebaseLaunchTicketResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
/// Generated server implementations.
pub mod group_knowledgebase_launch_ticket_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with GroupKnowledgebaseLaunchTicketServiceServer.
    #[async_trait]
    pub trait GroupKnowledgebaseLaunchTicketService: std::marker::Send + std::marker::Sync + 'static {
        async fn consume_group_knowledgebase_launch_ticket(
            &self,
            request: tonic::Request<super::ConsumeGroupKnowledgebaseLaunchTicketRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ConsumeGroupKnowledgebaseLaunchTicketResponse>,
            tonic::Status,
        >;
    ...
    #[derive(Debug)]
    pub struct GroupKnowledgebaseLaunchTicketServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> GroupKnowledgebaseLaunchTicketServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>>
    for GroupKnowledgebaseLaunchTicketServiceServer<T>
    where
        T: GroupKnowledgebaseLaunchTicketService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::Body>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sdkwork.communication.internal.v1.GroupKnowledgebaseLaunchTicketService/ConsumeGroupKnowledgebaseLaunchTicket" => {
                    #[allow(non_camel_case_types)]
                    struct ConsumeGroupKnowledgebaseLaunchTicketSvc<
                        T: GroupKnowledgebaseLaunchTicketService,
                    >(
                        pub Arc<T>,
                    );
                    ...
                    > tonic::server::UnaryService<
                        super::ConsumeGroupKnowledgebaseLaunchTicketRequest,
                    > for ConsumeGroupKnowledgebaseLaunchTicketSvc<T> {
                        type Response = super::ConsumeGroupKnowledgebaseLaunchTicketResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as GroupKnowledgebaseLaunchTicketService>::consume_group_knowledgebase_launch_ticket(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ConsumeGroupKnowledgebaseLaunchTicketSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for GroupKnowledgebaseLaunchTicketServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "sdkwork.communication.internal.v1.GroupKnowledgebaseLaunchTicketService";
...
/// Generated client implementations.
pub mod message_dispatch_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::http::Uri;
    #[derive(Debug, Clone)]
    pub struct MessageDispatchServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl MessageDispatchServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> MessageDispatchServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> MessageDispatchServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            MessageDispatchServiceClient::new(
                InterceptedService::new(inner, interceptor),
            )
        }
        /// Compress requests with the given encoding.
        ...
        pub async fn dispatch_conversation_message(
            &mut self,
            request: impl tonic::IntoRequest<super::DispatchConversationMessageRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DispatchConversationMessageResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
/// Generated server implementations.
pub mod message_dispatch_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with MessageDispatchServiceServer.
    #[async_trait]
    pub trait MessageDispatchService: std::marker::Send + std::marker::Sync + 'static {
        async fn dispatch_conversation_message(
            &self,
            request: tonic::Request<super::DispatchConversationMessageRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DispatchConversationMessageResponse>,
            tonic::Status,
        >;
    ...
    #[derive(Debug)]
    pub struct MessageDispatchServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> MessageDispatchServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>>
    for MessageDispatchServiceServer<T>
    where
        T: MessageDispatchService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::Body>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sdkwork.communication.internal.v1.MessageDispatchService/DispatchConversationMessage" => {
                    #[allow(non_camel_case_types)]
                    struct DispatchConversationMessageSvc<T: MessageDispatchService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: MessageDispatchService,
                    > tonic::server::UnaryService<
                        super::DispatchConversationMessageRequest,
                    > for DispatchConversationMessageSvc<T> {
                        type Response = super::DispatchConversationMessageResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MessageDispatchService>::dispatch_conversation_message(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DispatchConversationMessageSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for MessageDispatchServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "sdkwork.communication.internal.v1.MessageDispatchService";
    impl<T> tonic::server::NamedService for MessageDispatchServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
pub mod user_welcome_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::http::Uri;
    #[derive(Debug, Clone)]
    pub struct UserWelcomeServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl UserWelcomeServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> UserWelcomeServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> UserWelcomeServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            UserWelcomeServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn send_welcome_message(
            &mut self,
            request: impl tonic::IntoRequest<super::SendWelcomeMessageRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SendWelcomeMessageResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
/// Generated server implementations.
pub mod user_welcome_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with UserWelcomeServiceServer.
    #[async_trait]
    pub trait UserWelcomeService: std::marker::Send + std::marker::Sync + 'static {
        async fn send_welcome_message(
            &self,
            request: tonic::Request<super::SendWelcomeMessageRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SendWelcomeMessageResponse>,
            tonic::Status,
        >;
    ...
    #[derive(Debug)]
    pub struct UserWelcomeServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> UserWelcomeServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for UserWelcomeServiceServer<T>
    where
        T: UserWelcomeService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::Body>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sdkwork.communication.internal.v1.UserWelcomeService/SendWelcomeMessage" => {
                    #[allow(non_camel_case_types)]
                    struct SendWelcomeMessageSvc<T: UserWelcomeService>(pub Arc<T>);
                    impl<
                        T: UserWelcomeService,
                    > tonic::server::UnaryService<super::SendWelcomeMessageRequest>
                    for SendWelcomeMessageSvc<T> {
                        type Response = super::SendWelcomeMessageResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UserWelcomeService>::send_welcome_message(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SendWelcomeMessageSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for UserWelcomeServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "sdkwork.communication.internal.v1.UserWelcomeService";
    impl<T> tonic::server::NamedService for UserWelcomeServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
pub mod room_orchestration_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::http::Uri;
    #[derive(Debug, Clone)]
    pub struct RoomOrchestrationServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl RoomOrchestrationServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> RoomOrchestrationServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> RoomOrchestrationServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            RoomOrchestrationServiceClient::new(
                InterceptedService::new(inner, interceptor),
            )
        }
        /// Compress requests with the given encoding.
...
/// Generated server implementations.
pub mod room_orchestration_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with RoomOrchestrationServiceServer.
    #[async_trait]
    ...
    #[derive(Debug)]
    pub struct RoomOrchestrationServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> RoomOrchestrationServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>>
    for RoomOrchestrationServiceServer<T>
    where
                ...
                "/sdkwork.communication.internal.v1.RoomOrchestrationService/CreateRoom" => {
                    ...
                    for CreateRoomSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RoomOrchestrationService>::create_room(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/sdkwork.communication.internal.v1.RoomOrchestrationService/RetrieveRoom" => {
                    ...
                    for RetrieveRoomSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RoomOrchestrationService>::retrieve_room(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RetrieveRoomSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/sdkwork.communication.internal.v1.RoomOrchestrationService/EnterRoom" => {
                    ...
                    for EnterRoomSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RoomOrchestrationService>::enter_room(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/sdkwork.communication.internal.v1.RoomOrchestrationService/LeaveRoom" => {
                    ...
                    for LeaveRoomSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RoomOrchestrationService>::leave_room(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T> Clone for RoomOrchestrationServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "sdkwork.communication.internal.v1.RoomOrchestrationService";
    impl<T> tonic::server::NamedService for RoomOrchestrationServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
