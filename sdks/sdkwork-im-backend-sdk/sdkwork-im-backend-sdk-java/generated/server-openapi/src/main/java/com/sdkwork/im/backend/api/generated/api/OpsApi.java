...
public class OpsApi {
    ...
    /** Retrieve ops health */
    public HealthRetrieveResponse healthRetrieve() throws Exception {
        Object raw = client.get(ApiPaths.backendPath("/ops/health"));
        return client.convertValue(raw, new TypeReference<HealthRetrieveResponse>() {});
    }

    /** Retrieve cluster state */
    public ClusterRetrieveResponse clusterRetrieve() throws Exception {
    ...
    public RuntimeDirRetrieveResponse runtimeDirRetrieve() throws Exception {
        ...
        return client.convertValue(raw, new TypeReference<RuntimeDirRetrieveResponse>() {});
    }

    /** List provider bindings */
    public ProviderBindingSnapshotListResponse providerBindingsList(Integer pageSize, String cursor) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("page_size", pageSize, "form", true, false, null),
            new QueryParameterSpec("cursor", cursor, "form", true, false, null)
        ));
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/ops/provider_bindings"), query));
        return client.convertValue(raw, new TypeReference<ProviderBindingSnapshotListResponse>() {});
    }

    /** Retrieve provider binding drift */
    public ProviderBindingDriftListResponse providerBindingsDriftRetrieve(Integer pageSize, String cursor) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("page_size", pageSize, "form", true, false, null),
            new QueryParameterSpec("cursor", cursor, "form", true, false, null)
        ));
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/ops/provider_bindings/drift"), query));
        return client.convertValue(raw, new TypeReference<ProviderBindingDriftListResponse>() {});
    }
