# SDKWork API Product Runtime Component Specs

This directory is the local standards index for `sdkwork-api-product-runtime`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-api-product-runtime` |
| Type | `rust-crate` |
| Root | `sdkwork-im/crates/sdkwork-api-product-runtime` |
