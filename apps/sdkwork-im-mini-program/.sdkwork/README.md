# SDKWork IM Mini Program Application Workspace

This `.sdkwork/` directory is source-controlled workspace metadata for the
`sdkwork-im-mini-program` application root.
