...
export const VideoCall: React.FC = () => {
  ...
  const displayAvatar = chat ? chat.avatar : "https://cdn.sdkwork.com/apps/sdkwork-im-h5/mock/images/sarah-video/800x1600.png";
  ...
  return (
    <div className="flex flex-col h-full bg-black relative overflow-hidden">
      ...
      {callState === "connected" && !isVideoOff && (
        ...
        >
          <img
            src="https://cdn.sdkwork.com/apps/sdkwork-im-h5/mock/images/me-video/300x400.png"
            alt="Local Video"
            className={cn(
