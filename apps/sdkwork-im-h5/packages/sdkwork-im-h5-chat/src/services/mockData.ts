...
const INITIAL_CHATS: Chat[] = [
  ...
  },
  {
    ...
    type: "group",
    name: "Design Team",
    avatar: "https://cdn.sdkwork.com/apps/sdkwork-im-h5/mock/images/design/200x200.png",
...
const INITIAL_MESSAGES: Record<string, Message[]> = {
  c1: [
    ...
    },
    {
      ...
      chatId: "c1",
      senderId: "u1",
      content: "https://cdn.sdkwork.com/apps/sdkwork-im-h5/mock/audio/sample.mp3",
    ...
    },
    {
      ...
      chatId: "c1",
      senderId: "u1",
      content: "https://cdn.sdkwork.com/apps/sdkwork-im-h5/mock/images/park/300x200.png",
    ...
    },
    {
      ...
      chatId: "c1",
      senderId: "u1",
      content: "https://cdn.sdkwork.com/apps/sdkwork-im-h5/mock/videos/sample.mp4",
      timestamp: Date.now() - 1000 * 60 * 4,
      type: "video",
      metadata: {
        coverUrl: "https://cdn.sdkwork.com/apps/sdkwork-im-h5/mock/images/video/300x400.png",
        duration: "0:10",
      },
    },
    {
      ...
      metadata: {
        ...
        coverUrl: "https://cdn.sdkwork.com/apps/sdkwork-im-h5/mock/images/music_album/200x200.png",
      },
    },
    {
      id: "m1_13",
...
const STORAGE_KEY_CHATS = "sdkwork_im_h5_chats";
const STORAGE_KEY_MESSAGES = "sdkwork_im_h5_messages";
