    ...
    <div className="mt-10 mb-4 flex flex-col items-center">
      ...
      <div className="flex items-center justify-center gap-8 w-full max-w-[240px]">
        ...
        <div 
          ...
          className="w-12 h-12 rounded-full border border-border-color flex items-center justify-center bg-chat-other-bg active:scale-95 transition-transform cursor-pointer font-medium font-serif text-[24px] text-[#4285F4]"
        >
           G
        </div>
      </div>
