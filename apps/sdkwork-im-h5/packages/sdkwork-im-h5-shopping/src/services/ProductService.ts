...
const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: "159",
    originalPrice: "299",
    image: "https://picsum.photos/seed/product2/300/250",
    sales: "已售 8000+",
  ...
  },
  {
    ...
    price: "89",
    originalPrice: "129",
    image: "https://picsum.photos/seed/product3/300/450",
    sales: "已售 2000+",
  ...
  },
  {
    ...
    price: "28", // min price
    image: "https://picsum.photos/seed/coffee/300/350",
    sales: "已售 10w+",
    ...
    skus: [
      { id: "sku_1", specValues: { "denomination": "d_28" }, price: "28", originalPrice: "33", stock: 999, description: "可兑换一杯大杯拿铁或美式咖啡，全国任意门店通用", image: "https://picsum.photos/seed/sku_1/300/300" },
      { id: "sku_2", specValues: { "denomination": "d_32" }, price: "32", originalPrice: "38", stock: 999, description: "可兑换任意大杯星冰乐，含当季特饮", image: "https://picsum.photos/seed/sku_2/300/300" },
      { id: "sku_3", specValues: { "denomination": "d_50" }, price: "48", originalPrice: "56", stock: 999, description: "包含一杯大杯拿铁及任意切片蛋糕一份", image: "https://picsum.photos/seed/sku_3/300/300" }
    ]
  },
  {
    id: "p_virtual_2",
    ...
    price: "199",
    image: "https://picsum.photos/seed/community/300/400",
    sales: "已售 500+",
  ...
  },
  {
    ...
    price: "100", // min price
    image: "https://picsum.photos/seed/jd_card/300/300",
    sales: "已售 50w+",
    ...
    skus: [
      { id: "sku_v1", specValues: { "value": "v_100" }, price: "100", stock: 9999, description: "100元电子礼品卡，可在下单时抵扣任意自营商品金额，有效期36个月", image: "https://picsum.photos/seed/sku_v1/300/300" },
      { id: "sku_v2", specValues: { "value": "v_500" }, price: "500", stock: 9999, description: "500元电子礼品卡，可绑定账户后使用，适合企业发放福利", image: "https://picsum.photos/seed/sku_v2/300/300" },
      { id: "sku_v3", specValues: { "value": "v_1000" }, price: "1000", stock: 9999, description: "1000元大面额电子礼品卡，尊贵体验，馈赠佳品", image: "https://picsum.photos/seed/sku_v3/300/300" }
    ]
  },
  {
    id: "p_virtual_4",
    ...
    price: "45", // min price
    originalPrice: "50",
    image: "https://picsum.photos/seed/didi_card/300/300",
    sales: "已售 2w+",
    ...
    skus: [
      { id: "sku_d1", specValues: { "type": "t_kuaiche" }, price: "45", originalPrice: "50", stock: 500, description: "滴滴快车、优享通用50元代金券，限一次性使用", image: "https://picsum.photos/seed/sku_d1/300/300" },
      { id: "sku_d2", specValues: { "type": "t_zhuanche" }, price: "48", originalPrice: "50", stock: 200, description: "滴滴专车通用50元高端出行代金券，舒适体验", image: "https://picsum.photos/seed/sku_d2/300/300" }
    ]
  },
  {
    id: "p_virtual_5",
    ...
    price: "15", // min price
    originalPrice: "25",
    image: "https://picsum.photos/seed/tencent_vip/300/300",
    sales: "已售 15w+",
    ...
    skus: [
      { id: "sku_tv_1", specValues: { "duration": "dur_1m" }, price: "15", originalPrice: "25", stock: 9999, description: "腾讯视频VIP月卡，手机/电脑/Pad通用，不支持电视机端", image: "https://picsum.photos/seed/sku_tv1/300/300" },
      { id: "sku_tv_2", specValues: { "duration": "dur_3m" }, price: "45", originalPrice: "68", stock: 9999, description: "腾讯视频VIP季卡，畅享93天尊贵特权，免广告", image: "https://picsum.photos/seed/sku_tv2/300/300" },
      { id: "sku_tv_3", specValues: { "duration": "dur_12m" }, price: "158", originalPrice: "258", stock: 5000, description: "腾讯视频VIP年卡，限时特惠，全网热播剧抢先看", image: "https://picsum.photos/seed/sku_tv3/300/300" }
    ]
  },
  {
    id: "p_virtual_6",
    ...
    price: "98.5", 
    originalPrice: "100",
    image: "https://picsum.photos/seed/mobile_recharge/300/300",
    sales: "已售 100w+",
    ...
    skus: [
      { id: "sku_hf_1", specValues: { "operator": "op_cmcc" }, price: "99", originalPrice: "100", stock: 99999, description: "中国移动100元话费快充，支持全国号段，不含空号", image: "https://picsum.photos/seed/sku_hf1/300/300" },
      { id: "sku_hf_2", specValues: { "operator": "op_cucc" }, price: "98.5", originalPrice: "100", stock: 99999, description: "中国联通100元话费快充，官方直充，方便快捷", image: "https://picsum.photos/seed/sku_hf2/300/300" },
      { id: "sku_hf_3", specValues: { "operator": "op_ctcc" }, price: "98.5", originalPrice: "100", stock: 99999, description: "中国电信100元话费快充，24小时自动充值系统", image: "https://picsum.photos/seed/sku_hf3/300/300" }
    ]
  },
  {
    id: "p_virtual_7",
    ...
    price: "10", 
    image: "https://picsum.photos/seed/points_recharge/300/300",
    sales: "已售 50w+",
    ...
    skus: [
      { id: "sku_pts_1", specValues: { "points": "pts_100" }, price: "10", stock: 99999, description: "充值10元，立即到账100积分", image: "https://picsum.photos/seed/sku_pts1/300/300" },
      { id: "sku_pts_2", specValues: { "points": "pts_200" }, price: "20", stock: 99999, description: "充值20元，立即到账200积分", image: "https://picsum.photos/seed/sku_pts2/300/300" },
      { id: "sku_pts_3", specValues: { "points": "pts_500" }, price: "50", stock: 99999, description: "充值50元，立即到账500积分，额外赠送5积分", image: "https://picsum.photos/seed/sku_pts3/300/300" },
      { id: "sku_pts_4", specValues: { "points": "pts_1000" }, price: "100", stock: 99999, description: "充值100元，立即到账1000积分，额外赠送20积分", image: "https://picsum.photos/seed/sku_pts4/300/300" }
    ]
  },
  {
    id: "p_virtual_8",
    ...
    price: "1.99",
    originalPrice: "5",
    image: "https://picsum.photos/seed/subscription_vip/300/300",
    sales: "已售 8w+",
    ...
    skus: [
      { id: "sku_sub_1", specValues: { "sub_type": "sub_1d" }, price: "1.99", originalPrice: "5", stock: 999, description: "1天体验版。开通后当天立得30积分，额外送炫酷头像框体验。", image: "https://picsum.photos/seed/sku_sub1/300/300" },
      { id: "sku_sub_2", specValues: { "sub_type": "sub_7d" }, price: "9.9", originalPrice: "25", stock: 999, description: "7天短期包。连续7天，每天赠送40积分(共280积分)，并解锁专属表情包。", image: "https://picsum.photos/seed/sku_sub2/300/300" },
      { id: "sku_sub_3", specValues: { "sub_type": "sub_1m" }, price: "29.9", originalPrice: "68", stock: 999, description: "连续包月套餐。连续30天，每天赠送50积分(共1500积分)，专属特权铭牌。", image: "https://picsum.photos/seed/sku_sub3/300/300" },
      { id: "sku_sub_4", specValues: { "sub_type": "sub_1y" }, price: "199", originalPrice: "588", stock: 500, description: "年度尊享黑卡。连续365天，每天赠送100积分(共36500积分)，年度绝版装扮。", image: "https://picsum.photos/seed/sku_sub4/300/300" }
    ]
  }
];
