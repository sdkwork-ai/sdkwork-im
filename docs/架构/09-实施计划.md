...
- current state = evidence_collected_gate_blocked for Capacity Tier.
...
- Capacity Tier remains evidence_collected_gate_blocked because doc-captured backfill cannot replace dedicated topology runs.
